...
- **La landing refuerza su mensaje de soberanía y sustituye Ko-fi por pedir una estrella en GitHub (#728, #729)**: el apartado "Acerca de mí" ahora afirma "No hay ninguna empresa detrás de NetPulse" y cierra agradeciendo a quienes usan y aportan al proyecto, en lugar del cierre anterior. Se retira por completo Ko-fi (enlaces, icono y la clase `.kofi`) y, en su lugar, la columna del footer y las menciones de apoyo piden dar una estrella en GitHub (`footer.support` / `footer.star`), con el enlace a los stargazers y el icono de estrella.
