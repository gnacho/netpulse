...
const I18N = {
  ...
  en: {
    ...
    about: {
      ...
      p2: 'Over time, and consistently with the principles I believe in, I decided to make it free and share it with the community. The project grows richer with every person who runs it and sends feedback: thank you for using it, and for the suggestions that keep it improving.',
    },
    theater: {
    ...
    honest: {
      ...
      p2: 'If you like the project or want to help it grow, starring it on GitHub helps more than anything: it makes it visible to others. Sharing NetPulse also helps a lot.',
  ...
  es: {
    ...
    about: {
      ...
      title: 'No hay ninguna empresa detrás de NetPulse',
      ...
      p2: 'Con el tiempo, y de forma consecuente con los principios en los que creo, he decidido liberarlo y compartirlo con la comunidad. El proyecto se enriquece con cada persona que lo usa y aporta: gracias por usarlo y por las sugerencias que lo mejoran.',
    },
    theater: {
    ...
    honest: {
      ...
      p2: 'Si el proyecto te gusta o quieres ayudarlo a crecer, darle una estrella en GitHub ayuda más que nada: lo hace visible para otros. Difundir NetPulse también ayuda mucho.',
    ...
    footer: {
      ...
      support: 'Apoyar', star: 'Dale una estrella en GitHub', rights: 'AGPL-3.0 · Hecho en casa, para redes de casa.',
    },
  ...
  zh: {
    ...
    honest: {
      ...
      p2: '如果你喜欢这个项目或想帮助它成长，在 GitHub 上给它一颗星比什么都重要：它能让更多人看到。分享 NetPulse 也很有帮助。',
    ...
    footer: {
      ...
      support: '支持', star: '在 GitHub 上给它一颗星', rights: 'AGPL-3.0 · 在家中打造，为家庭网络而生。',
    },
  ...
  ar: {
    ...
    honest: {
      ...
      p2: 'إذا أعجبك المشروع أو تريد مساعدته على النمو، فمنحه نجمة على GitHub يساعد أكثر من أي شيء: يجعله مرئيًا للآخرين. مشاركة NetPulse مع الآخرين تساعد كثيرًا أيضًا.',
    ...
    footer: {
      ...
      support: 'الدعم', star: 'امنحه نجمة على GitHub', rights: 'AGPL-3.0 · صُنع في البيت، لشبكات البيوت.',
    },
  ...
  hi: {
    ...
    honest: {
      ...
      p2: 'अगर आपको प्रोजेक्ट पसंद है या इसे बढ़ाने में मदद करनी है, तो GitHub पर स्टार देना सबसे ज़्यादा मदद करता है: इससे वह दूसरों को दिखता है। NetPulse को शेयर करना भी बहुत मदद करता है।',
    ...
    footer: {
      ...
      support: 'सहयोग', star: 'GitHub पर स्टार दें', rights: 'AGPL-3.0 · घर पर बना, घर के नेटवर्क के लिए।',
    },
  ...
  pt: {
    ...
    honest: {
      ...
      p2: 'Se gosta do projeto ou quer ajudá-lo a crescer, dar-lhe uma estrela no GitHub ajuda mais do que tudo: torna-o visível para os outros. Divulgar o NetPulse também ajuda muito.',
    ...
    footer: {
      ...
      support: 'Apoiar', star: 'Dê uma estrela no GitHub', rights: 'AGPL-3.0 · Feito em casa, para redes de casa.',
    },
  ...
  fr: {
    ...
    honest: {
      ...
      p2: 'Si vous aimez le projet ou voulez l’aider à grandir, lui mettre une étoile sur GitHub aide plus que tout : cela le rend visible aux autres. Faire connaître NetPulse aide aussi beaucoup.',
  ...
  ja: {
    ...
    honest: {
      ...
      p2: 'プロジェクトを気に入っていただいたり、成長を手伝いたい場合は、GitHub でスターを付けるのが何よりの助けになります。他の人にも見つけてもらいやすくなります。NetPulse を広めていただくのも大きな助けになります。',
    ...
    footer: {
      ...
      support: '応援', star: 'GitHub でスターを付ける', rights: 'AGPL-3.0 · 家庭のネットワークのために、家庭で作られました。',
    },
  ...
  ru: {
    ...
    honest: {
      ...
      p2: 'Если проект вам нравится или вы хотите помочь ему расти, звезда на GitHub помогает больше всего: она делает его заметным для других. Рассказать о NetPulse тоже очень помогает.',
  ...
  de: {
    ...
    honest: {
      ...
      p2: 'Wenn dir das Projekt gefällt oder du es wachsen sehen willst, hilft ein Stern auf GitHub mehr als alles andere: Er macht es für andere sichtbar. NetPulse weiterzuempfehlen hilft ebenfalls sehr.',
    ...
    footer: {
      ...
      support: 'Unterstützen', star: 'Gib ihm einen Stern auf GitHub', rights: 'AGPL-3.0 · Zuhause gebaut, für Heimnetze.',
    },
...
const I18N_EXTRA = {
  en: {
    ...
    free: {
      ...
      note: 'If it serves you and you want to support development, starring it on GitHub is the way. Never a subscription.', cta: 'Read the license',
    },
    faq: {
      eyebrow: 'FAQ', title: 'Frequently asked questions',
      q1: 'Is NetPulse paid?', a1: 'No. It is free software (AGPL-3.0), with no premium tier and no plans. If you want to support it, star it on GitHub.',
  ...
  es: {
    ...
    free: {
      ...
      note: 'Si te sirve y quieres apoyar su desarrollo, una estrella en GitHub es la vía. Nunca una suscripción.', cta: 'Ver la licencia',
    },
    faq: {
      eyebrow: 'FAQ', title: 'Preguntas frecuentes',
      q1: '¿NetPulse es de pago?', a1: 'No. Es software libre (AGPL-3.0), sin versión premium ni planes. Si quieres apoyarlo, dale una estrella en GitHub.',
  ...
  zh: {
    ...
    free: {
      ...
      note: '如果它对你有用，想支持开发，就在 GitHub 上给它一颗星。永远不需要订阅。', cta: '查看许可证',
    },
    faq: {
      eyebrow: '常见问题', title: '常见问题',
      q1: 'NetPulse 收费吗?', a1: '不。它是自由软件（AGPL-3.0），没有高级版，也没有付费计划。想支持的话，就在 GitHub 上给它一颗星。',
  ...
  ar: {
    ...
    free: {
      ...
      note: 'إن أفادك وأردت دعم تطويره، فمنحه نجمة على GitHub هو الطريق. ليس اشتراكًا أبدًا.', cta: 'اقرأ الرخصة',
    },
    faq: {
      eyebrow: 'الأسئلة الشائعة', title: 'الأسئلة الشائعة',
      q1: 'هل NetPulse مدفوع؟', a1: 'لا. إنه برمجية حرة (AGPL-3.0)، بلا نسخة مدفوعة ولا خطط. وإن أردت دعمه، امنحه نجمة على GitHub.',
  ...
  hi: {
    ...
    free: {
      ...
      note: 'अगर यह काम आए और विकास को समर्थन देना चाहें, तो GitHub पर स्टार देना ही रास्ता है। कभी सब्सक्रिप्शन नहीं।', cta: 'लाइसेंस देखें',
    },
    faq: {
      eyebrow: 'सामान्य प्रश्न', title: 'अक्सर पूछे जाने वाले प्रश्न',
      q1: 'क्या NetPulse पेड है?', a1: 'नहीं। यह स्वतंत्र सॉफ्टवेयर है (AGPL-3.0), न प्रीमियम टियर न प्लान। समर्थन करना हो तो GitHub पर स्टार दें।',
  ...
  pt: {
    ...
    free: {
      ...
      note: 'Se lhe for útil e quiser apoiar o desenvolvimento, dar uma estrela no GitHub é o caminho. Nunca uma subscrição.', cta: 'Ver a licença',
    },
    faq: {
      eyebrow: 'FAQ', title: 'Perguntas frequentes',
      q1: 'O NetPulse é pago?', a1: 'Não. É software livre (AGPL-3.0), sem versão premium nem planos. Se quiser apoiar, dê-lhe uma estrela no GitHub.',
  ...
  fr: {
    ...
    free: {
      ...
      note: 'Si l’outil vous sert et que vous voulez soutenir son développement, une étoile sur GitHub est la voie. Jamais d’abonnement.', cta: 'Lire la licence',
    },
    faq: {
      eyebrow: 'FAQ', title: 'Questions fréquentes',
      q1: 'NetPulse est-il payant ?', a1: 'Non. C’est un logiciel libre (AGPL-3.0), sans version premium ni forfaits. Pour le soutenir, mettez-lui une étoile sur GitHub.',
  ...
  ja: {
    ...
    free: {
      ...
      note: '役に立ったら開発支援はGitHubのスターで。サブスクリプションは永遠にありません。', cta: 'ライセンスを見る',
    },
    faq: {
      eyebrow: 'FAQ', title: 'よくある質問',
      q1: 'NetPulseは有料ですか?', a1: 'いいえ。フリーソフトウェア（AGPL-3.0）で、プレミアム版もプランもありません。支援したい場合はGitHubでスターを付けてください。',
  ...
  ru: {
    ...
    free: {
      ...
      note: 'Если проект полезен и вы хотите поддержать разработку - звезда на GitHub - это путь. Никаких подписок.', cta: 'Читать лицензию',
    },
    faq: {
      eyebrow: 'FAQ', title: 'Частые вопросы',
      q1: 'NetPulse платный?', a1: 'Нет. Это свободное ПО (AGPL-3.0), без премиум-версии и тарифов. Поддержать можно, поставив звезду на GitHub.',
  ...
  de: {
    ...
    free: {
      ...
      note: 'Wenn es dir nützt und du die Entwicklung unterstützen willst, ist ein Stern auf GitHub der Weg. Niemals ein Abo.', cta: 'Lizenz lesen',
    },
    faq: {
      eyebrow: 'FAQ', title: 'Häufige Fragen',
      q1: 'Ist NetPulse kostenpflichtig?', a1: 'Nein. Es ist freie Software (AGPL-3.0), ohne Premium-Version und ohne Tarife. Wer es unterstützen möchte, gibt ihm einen Stern auf GitHub.',
